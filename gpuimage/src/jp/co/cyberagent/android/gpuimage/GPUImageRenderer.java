...
public class GPUImageRenderer implements Renderer, PreviewCallback {
    ...
    public interface OnFrameAvailableListener {
        void onFrameAvailable(int textureID, int rotation, float[] transform);
    }
    ...
    public interface OnSTFrameAvailableListener {
        void onSTFrameAvailable();
    }

    public void setOnSTFrameAvailableHandler(OnSTFrameAvailableListener onSTFrameAvailableListener) {
        this.onSTFrameAvailableListener = onSTFrameAvailableListener;
    }

    OnSTFrameAvailableListener onSTFrameAvailableListener;
