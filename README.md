...
你也可以在这里查看 iOS 平台的示例项目：[Agora-Video-Source-iOS](https://github.com/AgoraIO/Agora-Video-Source-iOS)
...
- 如果发现了示例代码的 bug, 欢迎提交 [issue](https://github.com/AgoraIO/Agora-Video-Source-Android/issues)
